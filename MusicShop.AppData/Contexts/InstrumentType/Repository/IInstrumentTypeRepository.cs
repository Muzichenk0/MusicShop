...
namespace MusicShop.AppData.Contexts.InstrumentType.Repository
{
    /// <summary>
    ...
    public interface IInstrumentTypeRepository
    {
        ...
        /// <returns>Выстроенное в оптимизированный запрос, перечисление из экземпляров <see cref="InstrumentTypeInfoResponse"/></returns>
        public Task<IQueryable<InstrumentTypeInfoResponse>> GetAllAsync(CancellationToken cancelToken = default);
        /// <summary>
        /// Получение типа инструмента, чей ID согласован с <paramref name="instTypeId", асинхронно.
        /// </summary>
        /// <param name="instTypeId"></param>
        /// <param name="cancelToken"></param>
        /// <returns>Экземпляр сущности <see cref="InstrumentTypeInfoResponse"/> с идентификатором - <paramref name="instTypeId"/></returns>
        public Task<InstrumentTypeInfoResponse> GetByIdAsync(Guid instTypeId, CancellationToken cancelToken = default);
        /// <summary>
