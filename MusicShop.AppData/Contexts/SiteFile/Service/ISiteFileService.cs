...
{
    /// <summary>
    /// Абстрактный тип, контракт, описывающий внешний интерфейс модели - сервис файла сайта
    /// </summary>
    public interface ISiteFileService
    {
        ...
        /// <summary>
        /// Обновление существующего файла, чей идентификатор согласован с <paramref name="fileId"/>, асинхронно
        /// </summary>
        /// <param name="fileId">Идентификатор файла</param>
        ...
        /// <summary>
        /// Получение содержимого из файла, асинхронно
        /// </summary>
        /// <param name="file">Файл</param>
        /// <returns>Массив из байтовы</returns>
        public Task<byte[]> GetBytesFromFileAsync(IFormFile file);
        /// <summary>
        /// Получение разрешение файла формы, асихнронно
        /// </summary>
        /// <param name="file">Файл</param>
        /// <returns>Разрешение файла</returns>
